...
####
task= 'cold_all'# cold_drug\cold_all
# Main program: iterate over different datasets
for dataset in datasets:
    print('\nrunning on ', wandb.config['model_st'] + '_' + dataset )
    processed_data_file_train = 'data_cold/' + dataset+'/cold_all/processed/processed_data_train.pt'
    processed_data_file_test = 'data_cold/' + dataset +'/cold_all/processed/processed_data_test.pt'
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        print('please run create_data.py to prepare data in pytorch format!')
    else:
        train_data = GATADataset(root='data_cold/davis/cold_all')
        test_data = GATADataset(root='data_cold/davis/cold_all')
