...
# GCN-CNN based model 
# TransformerConv + GCNConv + LSTM

class GATv2_GCN(torch.nn.Module): ##### TransformerConv
    def __init__(self, n_output=1, num_features_xd=78, num_features_xt=25,
                 n_filters=32, embed_dim=128, output_dim=128, dropout=0.2):

        super(GATv2_GCN, self).__init__()##### TransformerConv
    ...
    def forward(self, data):
        ...
        embedded_xt, _ = self.bilstm(embedded_xt)# lstm 
