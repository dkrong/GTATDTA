...
#from model.gatv2_gcn import GATv2_GCN

#from model.TRM2_cnn import TRM2_cnn
#from model.TRM2_lstm_cnn import TRM2_lstm_cnn
from model.gcn2_lstm import gcn2_lstm 
from model.gatv2_gcn_lstm import gatv2_gcn_lstm
...
datasets = [['davis','kiba'][int(0)]] # 0: davis ;  1: kiba
#modeling = [TRM2_cnn,TRM2_lstm_cnn][int(0)]
modeling = [gcn2_lstm,gatv2_gcn_lstm][int(1)] # 0: GATv2 ;  1: GATv2_GCN
# modeling = [GATv2,GATv2_GCN][int(1)] # 0: GATv2 ;  1: GATv2_GCN
